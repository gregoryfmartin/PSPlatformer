...
Wanna _not_ play PSPlatformer? Go ahead.
...
[![Vidya](https://img.youtube.com/vi/OR1jJGE70Xc/default.jpg)](https://www.youtube.com/live/OR1jJGE70Xc?si=Kq_1gGa1ZnZiXf1J)

If you want something to read along to, check out the repository wiki (WIP ATM).

Fortunately, the code is _extremely_ simple to follow along with. If you ever have any questions, feel free to reach out!
...
* trackd - Helped out with a bug related to the deinit routine to allow restarting the game without re-importing the module, also with ANSI synchronized output code.
